        ...
        <div class="card card-primary">
          ...
          <form role="form" id="quickForm" action="transaksi_proses.php" method="post">
            ...
            <div class="card-body">
              ...
              <th><input type="number" class="form-control" name="debet" placeholder="0" min="0"></th>
              <th><input type="number" class="form-control" name="kredit" placeholder="0" min="0"></th>
              <th><input type="submit" name="tambah" class="btn btn-success" value="Tambah"></th>
            ...
            <tr> 
              ...
              <th> <a class="btn btn-danger" title="Hapus Semua" href="transaksi_proses.php?hapusall=1; ?>"
                onclick="return confirm('Apakah anda yakin akan menghapus semua transaksi ?')">Hapus</a></th>
              </table>
            </div>
