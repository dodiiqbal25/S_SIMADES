...
<div class="container-fluid footer">
	<div class="row footer-upper">
		<div class="container">
			<div class="col-md-4">
				<h3 class="page-header">Kegiatan Lain</h3>
				<ul class="news-list">
			...
			<div class="col-md-4">
				<h3 class="page-header">Kegiatan 1</h3>
				<ul class="news-list">
			...
			<div class="col-md-4">
				<h3 class="page-header">Kegiatan 2</h3>
				<ul class="news-list">
	...
	<div class="row footer-bottom">
		<div class="col-md-12">
			<span class="copy">Copyright &copy; <?php echo date('Y');?> Portal SINPADA |  by <a style="color: red;" href='http/wa.me/6282219455926' title='Dodi Iqbal' target='_blank'>Dodi Iqbal</a>
			</span>
		</div>
	</div>
</div>
