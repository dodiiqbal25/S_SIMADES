...
<div class="style">
	<div class="header">
    	<span class="title">
        	<div align="center">
        		<img src="images/header1.jpg" width="840" height="120" />
            </div>
        </span>
    </div>
	<div class="menu">
			...
			<li>
				...
				<ul>
                    ...
                    <li><a href="?module=pembeli" class="icon pembeli">Pembeli</a></li>
				</ul>
			</li>
			<li><a href="#" class="icon transaksi">Transaksi</a>
				<ul>
                    ...
                    <li><a href="?module=hutang" class="icon returbeli">hutang</a></li>
                    <li><a href="?module=piutang" class="icon returbeli">piutang</a></li>
				</ul>            
            </li>
    ...
    <div class="footer" align="center">
    	<p>Program Kerja Praktek <a <span class="cls_hdt">KHAERUL UMAM</span></a>  <?php echo date("Y"); ?></p>
    </div>
</div>
</div>
</div>
