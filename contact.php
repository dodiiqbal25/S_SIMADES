					...
					<div class="col-md-8">
						<div class="post-detail">
							<div class="row post-title">
								<div class="col-sm-12">
									<h2>KONTAK KAMI</h2>
									<h5>Hubungi kami untuk memiliki layanan sistem informasi pengelolaan Bumdes, jika Anda berminat atau bertanya tanya seputar informasi lainnya, silahkan hungungi kami sesuai format dibawah. Terimkasih</h5>
								</div>
							</div>
								...
								<div class="col-sm-12">
									<table border="0" width="100%">
										...
										<tr>
											<th>E-mail</th>
											<td>: </td>
											<td>dodiiqbal20@gmail.com</td>
										</tr>
										<tr>
											<th>Alamat</th>
											<td>: </td>
											<td>Jl. Utama Desa Dukuhwidara,Kec. Pabedilan, Kab. Cirebon - 45193</td>
										</tr>
									</table>
								</div>
								<div class="clear"></div>
